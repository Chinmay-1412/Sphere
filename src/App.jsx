      ...
      {shape === 'HEART' && (
        <div style={{
          ...
          <p style={{
            ...
            color: '#ffdf7e',
            fontSize: '2.8rem', // Rouge Script is quite delicate, so 2.8rem looks best
            margin: 0,
            // This text shadow creates a subtle "inner glow" feel
            textShadow: '0 0 8px rgba(255, 223, 126, 0.4), 2px 2px 5px rgba(0,0,0,0.8)',
            opacity: 0.95,
            fontWeight: '400'
          }}>
            Hey there, Keep smiling. Ik you're going and dealing with really hectic situations. I just made this so that, it makes you feel relax and I just want to remind you that. I'm with you.
          </p>
        </div>
      )}
